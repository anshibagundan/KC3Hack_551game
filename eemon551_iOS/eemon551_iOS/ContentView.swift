            ...
            NavigationView {
                ...
                .navigationBarItems(
                    ...
                    trailing: Button(action: {
                        viewModel.showingAddQuestionSheet = true
                    }) {
                        Image(systemName: "plus")
                    }
                )
                .sheet(isPresented: $viewModel.showingAddQuestionSheet) {
...
struct QuestionDetailView: View {
    ...
    struct AddQuestionView: View {
        ...
        var body: some View {
            Form {
                TextField("名前(した2つは上からlocation_id,genre_id)", text: $name)
        ...
        var body: some View {
            Form {
                ...
                Button("変更") {
                    ...
                    viewModel.editQuestion(question: updatedQuestion)
                    presentationMode.wrappedValue.dismiss()
                }
